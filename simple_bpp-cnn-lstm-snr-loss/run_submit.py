...
def run_submit():
    ...
    for fold in [0,1,2,3,4]: #[0]: #
        for checkpoint in [6000]:
            name = '%s-%08d_model' %(mode,checkpoint)


            out_dir = '/root/share1/kaggle/2020/open_vaccine/result/simple-bbp-cnn-lstm6-mcrmse/sn1-fold-%d' % fold
            initial_checkpoint = \
...
def run_ensemble():
    ...
    for submit_dir in [
        '/root/share1/kaggle/2020/open_vaccine/result/simple-bbp-cnn-lstm6-mcrmse/sn1-fold-0/submit/remote-00006000_model',
        '/root/share1/kaggle/2020/open_vaccine/result/simple-bbp-cnn-lstm6-mcrmse/sn1-fold-1/submit/remote-00006000_model',
        '/root/share1/kaggle/2020/open_vaccine/result/simple-bbp-cnn-lstm6-mcrmse/sn1-fold-2/submit/remote-00006000_model',
        '/root/share1/kaggle/2020/open_vaccine/result/simple-bbp-cnn-lstm6-mcrmse/sn1-fold-3/submit/remote-00006000_model',
        '/root/share1/kaggle/2020/open_vaccine/result/simple-bbp-cnn-lstm6-mcrmse/sn1-fold-4/submit/remote-00006000_model',
    ...
    print(df_submit)
    print(df_submit.shape)
    df_submit.to_csv('/root/share1/kaggle/2020/open_vaccine/result/simple-bbp-cnn-lstm6-mcrmse/chk60-fold-01234-submission.csv')
